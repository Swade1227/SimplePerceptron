...
- There are now two lines, the moving line per click indicates the perceptrons guess at where it needs to be. If you want to mess around with it, I would suggest tweaking a few things:
...
3. You can also tweak the mousePressed() Function in the "Simple_Perceptron" file and instead make the animation automated which may be a better visual representaion of the perceptrons process for you.
